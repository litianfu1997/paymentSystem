package com.nnxy.payment.consumer.controller;

import com.alibaba.csp.sentinel.annotation.SentinelResource;
import com.alibaba.csp.sentinel.slots.block.BlockException;
import com.nnxy.common.utils.R;
import com.nnxy.payment.consumer.entitys.AccountEntity;
import com.nnxy.payment.consumer.entitys.AllEntity;
import com.nnxy.payment.consumer.fallback.ConsumerFallback;
import com.nnxy.payment.consumer.feign.BankServiceFeign;
import com.nnxy.payment.consumer.service.ConsumerService;
...
public class ConsumerController {
    ...
    public R test() {
        System.out.println("我是consumer82，我准备调用bank9001服务");
//        int i = 10 / 0;
